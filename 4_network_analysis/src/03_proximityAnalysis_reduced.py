...
address_gene_list_file = "../data/key_proteins_reduced.txt"
### ENTER PATH/NAME INPUT: DRUG BANK ###
address_drug_target_file = "../databases/9606.stitch_full_drug2target.tsv"

""" output addresses """
### ENTER PATH/NAME OUTPUT: PROXIMITY ANALYSIS RESULTS AS .csv ###
address_output_file = "../data/drug_network_proximity_results_all_drugs_reduced.csv" 
